...
try {
    ...
    $mail->Username   = 'villatunariferias@gmail.com';                     //SMTP username
    $mail->Password   = 'sygycowvpnsjxmgw';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('villatunariferias@gmail.com', 'VILLA TUNARI');
    $mail->addAddress('roddriqo@gmail.com', 'USUARIO');     //Add a recipient
