...
if (isset($_POST)) {
    if (!empty($_POST)) {
        ...
        $query = mysqli_query($conexion, "INSERT INTO registro(nombre,correo,contraseña,mensaje) VALUES ('$nombre','$correo','$contraseña','$mensaje')");
        if ($query) {
            ...
            <div class="modal-body">
                <form action="" method="POST" autocomplete="off">
                    <div class="form-group">
                        ...
                        <br>
                        <input  class="form-control" type="text" name="mensaje" placeholder="mensaje" required>
                    </div>
